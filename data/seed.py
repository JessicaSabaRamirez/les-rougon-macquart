...
def run():
    ...
    novels_data = [
        ...
        (4,  "la-conquete-de-plassans",    "La Conquête de Plassans",         "The Conquest of Plassans",            1874, "Plassans",
         "The ambitious priest Faujas gradually takes over the Mouret household and the town of Plassans for political ends, driving François Mouret to madness.",
         "L'abbé Faujas s'empare progressivement de la maison des Mouret et de la ville de Plassans, poussant François Mouret à la folie."),
        ...
        (6,  "son-excellence-eugene-rougon", "Son Excellence Eugène Rougon",  "His Excellency Eugène Rougon",        1876, "Paris",
         "Eugène Rougon, the great political animal of the family, navigates the corridors of imperial power — rising, falling, and rising again through sheer force of will and cynicism.",
         "Eugène Rougon, grand politique de la famille, navigue dans les couloirs du pouvoir impérial avec cynisme."),
        ...
        (10, "pot-bouille",                "Pot-Bouille",                     "Pot Luck",                            1882, "Paris — bourgeois apartment",
         "Octave Mouret arrives in Paris and takes up residence in a bourgeois apartment block. A savage satire of middle-class hypocrisy — the respectable façade concealing seething adultery, greed, and cruelty.",
         "Octave Mouret arrive à Paris. Satire féroce de la bourgeoisie, dont la façade respectable cache adultères, avarice et cruauté."),
        ...
        (16, "le-reve",                    "Le Rêve",                         "The Dream",                           1888, "Cathedral town",
         "Angélique, an orphan raised by embroiderers beside a Gothic cathedral, lives in a world of legend and religious dream, waiting for her prince. The most gentle and ethereal of the twenty novels.",
         "Angélique, orpheline élevée près d'une cathédrale gothique, vit dans un monde de légende et de rêve religieux."),
        ...
        (18, "largent",                    "L'Argent",                        "Money",                               1891, "Paris — the Bourse",
         "Aristide Saccard returns for a second speculative adventure, building a vast bank and crashing it spectacularly. A panorama of financial capitalism and its seductions.",
         "Aristide Saccard fonde une grande banque et la ruine spectaculairement. Panorama du capitalisme financier."),
    ...
    chars_data = [
        ...
        # ── GENERATION 2 — Rougon children ──────────────────────────────────
        {
            ...
            "branch": "rougon",
            "generation": 2,
            "description_en": "The eldest Rougon son and the great political animal of the family. A powerful, cynical minister under Napoleon III, he rises and falls and rises again through sheer force of will. He embodies the Second Empire's political machinery — brilliant, amoral, and utterly devoted to power for its own sake.",
            "description_fr": "Fils aîné des Rougon et grand politique de la famille. Ministre puissant sous Napoléon III, il incarne le pouvoir politique du Second Empire.",
            "physical_en": "Tall, massive, with a large head and the slow, deliberate movements of a man accustomed to dominating every room he enters.",
        ...
        },
        {
            ...
            "branch": "rougon",
            "generation": 2,
            "description_en": "Born Aristide Rougon, he changed his name to Saccard to shed the family's provincial associations. A feverish, brilliant capitalist who makes and loses multiple fortunes speculating on Haussmann's Paris and later on the Bourse. He is capitalism incarnate — irresistible, destructive, and capable of rising from every ruin.",
            "description_fr": "Né Aristide Rougon, il change de nom pour spéculer sur Paris haussmannien. Capitaliste fiévreux qui fait et perd plusieurs fortunes.",
            "physical_en": "Small, wiry, with quick gestures and bright, feverish eyes always scanning for the next opportunity.",
        ...
        },
        {
            ...
            "branch": "rougon",
            "generation": 2,
            "description_en": "Pierre's daughter, married to her cousin François Mouret. She falls increasingly under the spiritual influence of the priest Faujas, which destroys her marriage and her family. Her religious mania is one of Zola's studies in the hereditary nervousness descending from Adélaïde.",
            "description_fr": "Fille de Pierre, mariée à son cousin François Mouret. Elle tombe sous l'influence de l'abbé Faujas, ce qui détruit sa famille.",
            "physical_en": "Pale, gentle, with the distracted look of someone whose inner religious life has become more real than the outer world.",
            "featured_on_landing": False, "tree_x": None, "tree_y": None,
        },
        ...
        # ── GENERATION 2 — Mouret branch (children of Ursule) ───────────────
        {
            ...
            "branch": "mouret",
            "generation": 2,
            "description_en": "Son of Ursule Macquart and Mouret the hatter. A quiet, orderly man who values routine and domestic peace above everything. He is systematically dispossessed of his household and sanity by the scheming Abbé Faujas, ending his days in madness — one of the cycle's most chilling studies in a good man's destruction.",
            "description_fr": "Fils d'Ursule Macquart et du chapelier Mouret. Homme tranquille et méthodique poussé à la folie par l'abbé Faujas.",
            "physical_en": "Neat, careful in dress, with the methodical bearing of a man who values order and routine.",
            "featured_on_landing": False, "tree_x": None, "tree_y": None,
        },
        {
        ...
        },
        {
            ...
            "branch": "other",
            "generation": 2,
            "description_en": "The antagonist of La Conquête de Plassans. A cold, ambitious, politically directed priest sent to Plassans to deliver the town's vote for the Empire. He lodges with the Mouret family and methodically takes over their household, social life, and ultimately their sanity — a study in the corruption of power dressed in clerical black.",
            "description_fr": "Antagoniste de La Conquête de Plassans. Prêtre ambitieux envoyé à Plassans pour livrer la ville à l'Empire, il s'empare systématiquement de la maison des Mouret.",
            "physical_en": "Tall, square-shouldered, with a hard jaw and impenetrable dark eyes — a man of iron will dressed in priestly black.",
            "featured_on_landing": False, "tree_x": None, "tree_y": None,
        },
        {
            "slug": "roubaud",
        ...
        },
        {
            ...
            "branch": "rougon",
            "generation": 2,
            "description_en": "Aristide Saccard's second wife — beautiful, bored, and destroyed by the excesses of Second Empire society. Aristide married her to cover up a scandal, and she finds herself with money, a carriage, and nothing real to live for. Her affair with her stepson Maxime is the scandalous centrepiece of La Curée, and its ending is one of Zola's most pitiless.",
            "description_fr": "Deuxième femme d'Aristide Saccard. Belle et désœuvrée, elle est détruite par les excès du Second Empire. Sa liaison avec Maxime est au cœur de La Curée.",
            "physical_en": "Magnificent, extravagantly dressed, with the glittering eyes of a woman on the permanent edge of nervous collapse.",
            "featured_on_landing": False, "tree_x": None, "tree_y": None,
        },
        ...
        },
        {
            ...
            "branch": "mouret",
            "generation": 3,
            "description_en": "The charismatic, brilliant entrepreneur who builds Au Bonheur des Dames — one of the first great Parisian department stores — and in doing so destroys the small traders around it. He understands women better than they understand themselves, and exploits that understanding ruthlessly — until Denise Baudu unmakes him. A figure of dazzling, amoral modernity.",
            "description_fr": "Entrepreneur brillant qui bâtit Au Bonheur des Dames et écrase les petits commerçants. Son amour pour Denise Baudu humanise son épopée capitaliste.",
            "physical_en": "Handsome, charming, with the easy grace of a man who has always succeeded with women and with business, and who has never doubted either.",
        ...
        },
        {
            ...
            "branch": "rougon",
            "generation": 3,
            "description_en": "Son of Aristide Saccard. A beautiful, debauched, and entirely passive young man who lives for pleasure at the height of the Empire's excess. His incestuous relationship with his stepmother Renée is the scandalous centrepiece of La Curée. He reappears in L'Argent, older and richer, having inherited his father's talent for survival without his energy.",
            "description_fr": "Fils d'Aristide, beau dandy débauché, symbole des excès du Second Empire. Sa relation avec sa belle-mère Renée est un des moments scandaleux du cycle.",
            "physical_en": "Exquisitely dressed, languid, with a cold, perfect beauty that conceals complete moral nullity.",
        ...
        },
        {
            ...
            "branch": "rougon",
            "generation": 3,
            "description_en": "An orphan raised by embroiderers beside a Gothic cathedral. She lives in a world of medieval legend and religious dream, constructing an ideal love from the lives of saints. The most ethereal character in the cycle — Le Rêve is the gentlest of the twenty novels, its softness a deliberate relief after the violence and darkness elsewhere.",
            "description_fr": "Orpheline élevée près d'une cathédrale gothique dans un monde de légende médiévale et de rêve religieux. La plus éthérée des personnages du cycle.",
            "physical_en": "Fair, delicate, with an almost translucent quality — she seems lit from within by her own luminous inner world.",
            "featured_on_landing": False, "tree_x": None, "tree_y": None,
        },
        {
        ...
        },
        {
            ...
            "branch": "other",
            "generation": 3,
            "description_en": "A major character in L'Argent — the sister of the engineer Hamelin, whose plans Saccard exploits for his Universal Bank. She becomes Saccard's mistress and, uniquely, manages to extract herself from his disaster with her dignity intact. Zola uses her as the novel's moral voice, clear-eyed about capitalism's seductions without being destroyed by them.",
            "description_fr": "Personnage central de L'Argent. Maîtresse de Saccard, elle incarne la lucidité morale face aux séductions du capitalisme.",
            "physical_en": "Dark, handsome, with the intelligent eyes of a woman who understands men well and is not deceived by them.",
            "featured_on_landing": False, "tree_x": None, "tree_y": None,
        },
        {
    ...
    events_data = [
        ...
        (
            ...
            "The Second Empire at its zenith — Paris dazzles the world with its Universal Exposition. Eleven million visitors attend. Behind the glittering spectacle, Eugène Rougon's political manoeuvring continues unabated.",
            "Le Second Empire à son apogée. Paris éblouit le monde avec son Exposition universelle. Derrière la fête, Eugène Rougon manœuvre dans les couloirs du pouvoir.",
            ["eugene-rougon"],
        ),
        (
            "Saccard's bank crashes on the Bourse",
            "Effondrement de la banque de Saccard",
            1867, "c. 1867", "personal",
            "largent",
            "Aristide Saccard's Banque Universelle, built on speculation and grandeur, crashes spectacularly on the Bourse. He loses everything — again. Saccard falls as he always falls: loudly, publicly, magnificently, and with the certainty that he will rise once more.",
            "La Banque Universelle d'Aristide Saccard s'effondre en Bourse. Il perd tout — encore une fois. Mais Saccard se relève toujours.",
            ["aristide-saccard"],
        ),
        (
